<?php
                 ...
                 require('../connection/Conneccion.php'); //Clase para realizar la conexión
                /******************************************************************************************************************/
                 class TaskDao implements metodos
                 {
                   /*********************Método para extraer todoas la tareas*************************************************************/
                     public function readAll()
                     {
                         ...
                         $result = $conn->query('select * from task'); // ejecutamos la consulta para que nos devuelva todas las tareas
                     ...
                     public function read($id)
                     {
                         ...
                         $result = $conn->query(sprintf("select * from task where id='%s'",$id));
                     ...
                     public function create($task)
                     {
                         $instance = Connecion::getInstance();
                         $conn = $instance->getCnx();
                         $sql = sprintf("insert into task (task, date_task) values('%s','%s')",$task->getTask(),$task->getDateTask());
                     ...
                     public function update($task)
                     {
                         $instance = Connecion::getInstance();
                         $conn = $instance->getCnx();
                         $sql = sprintf("update task set task='%s', date_task='%s' where id='%s'",$task->getTask(),$task->getDateTask(),$task->getId());
                         if ($conn->query($sql))
                         {
                             $conn->close();
                             return true;
                     ...
                     public function delete($id)
                     {
                         $instance = Connecion::getInstance();
                         $conn = $instance->getCnx();
                         $sql = sprintf("delete from task where id='%s'",$id);
                         if($conn->query($sql))
                         {
                             $conn->close();
                             return true;
